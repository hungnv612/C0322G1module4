...
public class ContractDto {
    ...
    public ContractDto(int contractId, Date contractStartDay, Date contractEndDay, double contractDeposit, Employee employee, Customer customer, Facility facility) {
